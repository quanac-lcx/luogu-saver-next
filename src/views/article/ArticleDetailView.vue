...
import { useMessage, useDialog, NSpace, NButton, NIcon, NTag, NDivider, NGrid, NGi } from 'naive-ui';
import {
...
import LoadingSkeleton from '@/components/LoadingSkeleton.vue'; // 之前封装的骨架屏
			...
			<div v-if="article">
				...
				>
					...
					<n-space>
						 ...
						 <n-button size="small" secondary tag="a" :href="`https://www.luogu.com/article/${article.id}`" target="_blank">
